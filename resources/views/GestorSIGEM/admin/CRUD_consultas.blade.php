<div class="bg-transparent">
    <div class="d-flex justify-content-between align-items-center mb-2">
        <h5 class="mb-0 text-white"><i class="bi bi-search"></i> Consultas Express</h5>
    ...
    <div class="tab-pane fade show active" id="nav-contenidos" role="tabpanel" aria-labelledby="nav-contenidos-tab">
        ...
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb bg-transparent py-2 mb-3">
                <li class="breadcrumb-item"><a href="#" onclick="event.preventDefault(); document.getElementById('nav-temas-tab').click();" class="text-decoration-none">Temas CE</a></li>
                <li class="breadcrumb-item"><a href="#" onclick="event.preventDefault(); document.getElementById('nav-subtemas-tab').click();" class="text-decoration-none">Subtemas CE</a></li>
        ...
        <div class="d-flex justify-content-between align-items-center mb-2">
            <div>
                <h6 class="mb-0 text-white"><i class="bi bi-file-earmark-text-fill"></i> Contenidos de Consultas Express</h6>
                <small class="text-white-50">Gestiona el contenido HTML de las consultas express</small>
            </div>
            <button type="button" class="btn btn-warning btn-sm" data-bs-toggle="modal" data-bs-target="#modalAgregarContenido">
            ...
            <div class="p-2">
                @if(isset($ce_contenidos) && count($ce_contenidos) > 0)
                    <div class="table-responsive">
                        <table id="tablaContenidosCE" class="table table-striped table-hover table-sm bg-white">
    ...
    <div class="tab-pane fade" id="nav-subtemas" role="tabpanel" aria-labelledby="nav-subtemas-tab">
        ...
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb bg-transparent py-2 mb-3">
                <li class="breadcrumb-item"><a href="#" onclick="event.preventDefault(); document.getElementById('nav-temas-tab').click();" class="text-decoration-none">Temas CE</a></li>
                <li class="breadcrumb-item active" aria-current="page">Subtemas CE</li>
                <li class="breadcrumb-item"><a href="#" onclick="event.preventDefault(); document.getElementById('nav-contenidos-tab').click();" class="text-decoration-none">Contenidos</a></li>
            </ol>
        </nav>

        <div class="d-flex justify-content-between align-items-center mb-2">
            <div>
                <h6 class="mb-0 text-white"><i class="bi bi-bookmarks-fill"></i> Subtemas de Consultas Express</h6>
        ...
        <div class="bg-dark bg-opacity-10 rounded">
            <div class="p-2">
                @if(isset($ce_subtemas) && count($ce_subtemas) > 0)
                    <div class="table-responsive">
                        <table id="tablaSubtemasCE" class="table table-striped table-hover table-sm bg-white">
    ...
    <div class="tab-pane fade" id="nav-temas" role="tabpanel" aria-labelledby="nav-temas-tab">
        ...
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb bg-transparent py-2 mb-3">
                <li class="breadcrumb-item active" aria-current="page">Temas CE</li>
                <li class="breadcrumb-item"><a href="#" onclick="event.preventDefault(); document.getElementById('nav-subtemas-tab').click();" class="text-decoration-none">Subtemas CE</a></li>
                <li class="breadcrumb-item"><a href="#" onclick="event.preventDefault(); document.getElementById('nav-contenidos-tab').click();" class="text-decoration-none">Contenidos</a></li>
            </ol>
        </nav>
        ...
        <div class="d-flex justify-content-between align-items-center mb-2">
            <div>
                <h6 class="mb-0 text-white"><i class="bi bi-bookmark-fill"></i> Temas de Consultas Express</h6>
                <small class="text-white-50">Gestiona los temas principales para las consultas express</small>
            </div>
            <button type="button" class="btn btn-info btn-sm" data-bs-toggle="modal" data-bs-target="#modalAgregarTema">
        ...
        <div class="bg-dark bg-opacity-10 rounded">
            <div class="p-2">
                @if(isset($ce_temas) && count($ce_temas) > 0)
                    <div class="table-responsive">
                        <table id="tablaTemasCE" class="table table-striped table-hover table-sm bg-white">
...
<div class="modal fade" id="modalAgregarTema" tabindex="-1">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form id="formAgregarTema" method="POST" action="{{ route('sgiem.admin.consultas.tema.crear') }}">
                @csrf
...
$(document).ready(function() {
    ...
    $('#tablaTemasCE').DataTable({
        ...
        order: [[0, 'asc']], // Ordenar por tema por defecto
        pageLength: 10,
    ...
    $('#tablaContenidosCE').DataTable({
        ...
        order: [[4, 'desc']], // Ordenar por fecha más reciente por defecto
        pageLength: 10,
        lengthMenu: [[5, 10, 25, 50, -1], [5, 10, 25, 50, "Todos"]],
        dom: '<"row"<"col-sm-12 col-md-6"l><"col-sm-12 col-md-6"f>>' +
             '<"row"<"col-sm-12"tr>>' +
...
function verTablaContenidoCE(id) {
    ...
    fetch(`{{ url('/sgiem/admin/consultas/contenido') }}/${id}`)
        .then(response => {
            if (!response.ok) {
