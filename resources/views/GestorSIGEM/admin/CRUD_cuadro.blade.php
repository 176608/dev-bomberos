...
<div class="modal fade" id="modalAgregarCuadro" tabindex="-1">
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
            ...
            <form id="formAgregarCuadro" method="POST" action="{{ route('sgiem.admin.cuadros.crear') }}" enctype="multipart/form-data">
                @csrf
...
const routesCuadros = {
    update: '{{ route("sgiem.admin.cuadros.actualizar", ":id") }}',
    delete: '{{ route("sgiem.admin.cuadros.eliminar", ":id") }}',
    subtemasPorTema: '{{ url("/sgiem/admin/cuadros/subtemas") }}',
    obtenerCuadro: '{{ route("sgiem.admin.cuadros.obtener", ":id") }}'
};
