...
<div class="modal fade" id="modalAgregarMapa" tabindex="-1">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <form id="formAgregarMapa" method="POST" action="{{ route('sgiem.admin.mapas.crear') }}" enctype="multipart/form-data">
                @csrf
...
const routes = {
    update: '{{ route("sgiem.admin.mapas.actualizar", ":id") }}',
    delete: '{{ route("sgiem.admin.mapas.eliminar", ":id") }}'
};
