...
<script>
// === FUNCIONES ESPECÍFICAS DE INICIO ===
function loadInicioData() {
    ...
    fetch(`${baseUrl}/datos-inicio`)
        ...
        .then(data => {
            console.log('BLADE: Datos de inicio cargados:', data);
            ...
            if (data.success) {
                ...
                console.warn('BLADE: Error en datos de inicio:', data.message);
            }
        })
        .catch(error => {
            console.error('BLADE: Error cargando datos de inicio:', error);
        });
}

// Exponer función al scope global para que sigem.js pueda llamarla
window.loadInicioData = loadInicioData;

// Auto-ejecutar si estamos en la página de inicio
document.addEventListener('DOMContentLoaded', function() {
    // Solo ejecutar si hay elementos específicos de inicio en la página
    if (document.getElementById('stat-temas') || document.getElementById('stat-subtemas')) {
        loadInicioData();
    }
});
</script>