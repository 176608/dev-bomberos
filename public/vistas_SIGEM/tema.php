...
<div class="main-card"></div>
    ...
    <div class="container mt-4">
        <h2 class="mb-3">Listado de Temas</h2>

        <a href="tema_agregar.php" class="btn btn-success mb-3">Nuevo Tema</a>
        ...
        <table class="table table-bordered table-striped">
            ...
            <?php while ($row = $temas->fetch_assoc()): ?>
                <tr>
                    <td><?= $row['ce_tema_id'] ?></td>
                    <td><?= htmlspecialchars($row['tema']) ?></td>
                    <td>
                        <a href="tema_editar.php?id=<?= $row['ce_tema_id'] ?>" class="btn btn-warning btn-sm">Editar</a>
                        <a href="tema_eliminar.php?id=<?= $row['ce_tema_id'] ?>" class="btn btn-danger btn-sm" onclick="return confirm('¿Eliminar este tema?')">Eliminar</a>
                    </td>
                </tr>
            <?php endwhile; ?>
            </tbody>
