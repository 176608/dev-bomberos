...
<!-- Contenido principal -->
<div class="main-card">
    <h3 class="text-center text-success mb-4">Actualizar PDF para el cuadro ID <?php echo htmlspecialchars($cuadro_id); ?></h3>

    <form method="POST" action="guardar_pdf.php" enctype="multipart/form-data" class="text-center" id="formPDF">
        ...
        <div class="mb-3 w-50 mx-auto">
            <input type="file" name="nuevo_pdf" accept="application/pdf" class="form-control" required>
        </div>
...
document.addEventListener("DOMContentLoaded", function () {
    const formularioPDF = document.getElementById('formPDF');
    if (formularioPDF) {
        formularioPDF.addEventListener('submit', function (e) {
            const confirmado = confirm("⚠️ Esta acción reemplazará el archivo PDF actual.\n¿Deseas continuar?");
