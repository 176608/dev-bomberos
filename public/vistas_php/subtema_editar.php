...
<div class="container mt-4">
    ...
    <form method="post">
        <div class="mb-3">
            ...
            <input type="text" class="form-control" id="ce_subtema" name="ce_subtema" value="<?= htmlspecialchars($subtema['ce_subtema']) ?>" required>
        </div>
        <div class="mb-3">
            ...
            <select class="form-select" id="ce_tema_id" name="ce_tema_id" required>
                <?php while ($row = $temas->fetch_assoc()): ?>
                    <option value="<?= $row['ce_tema_id'] ?>" <?= ($row['ce_tema_id'] == $subtema['ce_tema_id']) ? 'selected' : '' ?>>
...
<div class="footer-logos">
    <img src="logosfinales2.png" alt="IMIP">
    <img src="logoadmin.png" alt="Gobierno Municipal">
    <img src="sige2.png" alt="SIGEM">
</div>
