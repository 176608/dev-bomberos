...
<head>
    ...
    <style>
        ...
        .descargas a { margin-left: 10px; margin-bottom: 5px; display: inline-block; }
...
<div class="top-bar">
    ...
    <div class="right-section">
        ...
        <?php if ($usuario !== 'Público'): ?>
            <div><a href="logout.php" class="btn btn-light btn-sm">Cerrar sesión</a></div>
        <?php else: ?>
            <div><a href="login.php" class="btn btn-light btn-sm">Iniciar sesión</a></div>
        <?php endif; ?>
    </div>
</div>
...
<div class="main-card">
        ...
        <select id="temaSelect" class="form-select w-75 mx-auto">
            ...
            if ($temas && mysqli_num_rows($temas) > 0) {
                while ($fila = mysqli_fetch_assoc($temas)) {
                    $selected = ($fila['nombre_archivo'] === 'localidades.php') ? 'selected' : '';
    ...
    <div class="row">
        <div class="col-md-2">
            <div class="text-center mb-3 mt-2"></div>
            <div class="d-flex flex-column gap-3 align-items-center">
                <a href="localidades.php" class="sidebar-icon">
                    <img src="imagenes/Localidades.png"><p>Localidades</p>
                </a>
                <a href="densidad.php" class="sidebar-icon">
                    <img src="imagenes/Densidad.png"><p>Densidad</p>
                </a>
            </div>
        </div>
        ...
        <div class="col-md-10">
            ...
            <?php foreach ($cuadros as $index => $cuadro): ?>
                <h4 class="titulo-cuadro toggle-titulo" data-target="contenedor-<?php echo $index; ?>" style="text-align:left;">
                ...
                <div id="contenedor-<?php echo $index; ?>" style="display:none;">
                    <div class="descargas mb-2" style="display:flex; justify-content:center; gap:8px; flex-wrap:wrap; align-items:center;">
                        ...
                        <a href="cuadro/uploads/<?php echo $tema . '/pdf/' . $cuadro['pdf_file']; ?>" class="btn btn-outline-danger btn-sm" target="_blank">📄 PDF</a>
                        <?php endif; ?>
                ...
                <?php endif; ?>
                        ...
                        <?php if ($usuario === 'admin'): ?>
                            ...
                            <a href="editar_csv.php?archivo=<?= $cuadro['nombe_archivo_csv'] ?>&tema=<?= $tema ?>" class="btn btn-outline-dark btn-sm">✏️ Editar CSV</a>
                        <?php endif; ?>
                    </div>
