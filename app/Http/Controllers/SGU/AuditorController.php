...
class AuditorController
{
    ...
    {
        $accesos = AuditoriaAcceso::with('usuario')->orderByDesc('created_at')->paginate(500);
    ...
    {
        $auditorias = AuditoriaUsuario::with(['usuario', 'actor'])->orderByDesc('created_at')->paginate(500);
